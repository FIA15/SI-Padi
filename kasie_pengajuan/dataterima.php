...
<section class="content-header">
    <h1>
        Pengajuan
        <small>Data Pengajuan Diterima</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i></a></li>
        <li class="active">Transaksi / Pengajuan / Diterima</li>
    </ol>
</section>
...
<section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Data Pengajuan Diterima</h3>
                <div class="pull-right">
                    <a href="data.php" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-triangle-left"></i> Kembali</a>
                    <a href="<?=base_url('cetak/terima.php')?>" class="btn btn-warning btn-flat"><i class="fa fa-book"></i> Report</a>
                </div>
            </div>   

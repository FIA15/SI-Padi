...
<section class="content-header">
    <h1>
        Pengajuan
        <small>Data Pengajuan Ditolak</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i></a></li>
        <li class="active">Transaksi / Pengajuan / Ditolak</li>
    </ol>
</section>
...
<section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Data Pengajuan Ditolak</h3>
                <div class="pull-right">
                    <a href="data.php" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-triangle-left"></i> Kembali</a>
                    <a href="<?=base_url('cetak/tolak.php')?>" class="btn btn-warning btn-flat"><i class="fa fa-book"></i> Report</a>
                </div>
            </div>   
            <div class="box-body table-responsive">
                ...
                $query = "SELECT * FROM pengajuan
                            ...
                            WHERE pengajuan.approve1 = 2 OR approve2 = 2 OR approve3 = 2 
                ...
                if(mysqli_num_rows($sql_pengajuan) > 0){
                    while($data = mysqli_fetch_array($sql_pengajuan)){
                        ...
                        <tr>
                            ...
                            <td><?=$data['notelp']?></td>   
                            <td><?=$status?></td>
                            <td><?=$data['ket1']?><?=$data['ket2']?><?=$data['ket3']?></td>

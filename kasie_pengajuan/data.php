...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Transaksi / Pengajuan </li>
    </ol>
</section>
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="datatunggu.php" class="btn btn-warning btn-flat"><i class="fa fa-check-circle"></i> Menunggu</a>
                    ...
                    <a href="<?=base_url('cetak/pengajuan.php')?>" class="btn btn-warning btn-flat"><i class="fa fa-book"></i> Report</a>
                </div>
            </div>   

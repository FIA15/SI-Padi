...
<section class="content-header">
    <h1>
        Approve 3
        <small>Data Approve 3 Ditolak</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i></a></li>
        <li class="active">Transaksi / Approve 3 / Data Pengajuan Ditolak</li>
    </ol>
</section>
...
<section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Data Approve 3 Ditolak</h3>
            ...
            <div class="box-body table-responsive">
                ...
                $query = "SELECT * FROM pengajuan
                            ...
                            WHERE pengajuan.approve1 = 1 AND approve2 = 1 AND approve3 = 2

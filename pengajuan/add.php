                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="proses.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>ID Pengajuan *</label><small>
                            ...
                            <?php
                                $query = mysqli_query($con, "SELECT max(id_pengajuan) as kodeTerbesar FROM pengajuan") or die (mysqli_error($con));
                                ...
                                $kodeBarang = $huruf.'-'.sprintf("%03s", $urutan).'/'.$desa.'/'.$kecamatan.'/'.date('dmy');
                            ?>
                            <input type="text" name="id" value="<?=$kodeBarang?>" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama*</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="tanggal"  value="<?=date('Y-m-d')?>" class="datepicker span2 form-control" id="datepicker" required readonly>
                            </div>
                        </div>  
                        <div class="form-group">

...
<section class="content-header">
      <h1>
        Approve 2
        <small>Detail Data Tunggu Pengajuan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i></a></li>
        <li class="active ">Transaksi / Approve 2 / Detail Pengajuan  <li>
      </ol>
</section>
<!-- Main content -->
            ...
            <div class="row">
                ...
                ?>
                    <form action="proses.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="radio" name="approve2" value="1" class="form-control flat-red" checked> Terima &emsp;
                            <input type="radio" name="approve2" value="2" class="form-control flat-red" > Tolak
                        </div>
                        <div class="form-group">
                            <label>Keterangan *</label>
                            <textarea name="ket2" id="" class="form-control"></textarea>
                        </div>
                        <div class="form-group">

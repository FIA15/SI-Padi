...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active ">Transaksi / Approve 1 / Detail Pengajuan  </li>
      </ol>
</section>
<!-- Main content -->
            ...
            <div class="row">
                ...
                ?>
                    <form action="proses.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="radio" name="approve1" value="1" class="form-control flat-red" checked> Terima &emsp;
                            <input type="radio" name="approve1" value="2" class="form-control flat-red" > Tolak
                        </div>
                        <div class="form-group">
                            <label>Keterangan *</label>
                            <textarea name="ket1" id="" class="form-control"></textarea>
                        </div>
                        <div class="form-group">

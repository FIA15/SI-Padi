...
<section class="content-header">
      <h1>
        Approve 1
        <small>Lihat Detail Pengajuan Ditolak</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i></a></li>
        <li class="active ">Transaksi / Approve 1 / Data Pengajuan Ditolak / Detail <li>
      </ol>
</section>
<!-- Main content -->
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Detail Pengajuan Ditolak</h3>
